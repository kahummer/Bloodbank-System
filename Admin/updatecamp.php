...
<table border="0" align="center" width="400" height="500px">
<tr><td colspan="2" align="center"><span style="font-weight: bolder;"> Update Camp </span> </td></tr>
...
<tr>
	...
	<td><input type="text" name="t3" value="<?php if(isset($_POST["show"])){echo $camp_title;} ?>"/ required="required" pattern="[a-zA-Z0-9]{5,40}" title="please enter only character or numbers between 5 to 40 for camp title"></td>
</tr>
   <tr>
   	  <td class="lefttd">Organized By</td>
   	  <td><input type="text" name="t2" value="<?php if(isset($_POST["show"])){echo $organized_by;} ?>" required="required" pattern="[a-zA-Z0-9]{5,45}" title="please enter only character or numbers between 5 to 45 for organizer name"/></td>
   </tr>
<tr>
