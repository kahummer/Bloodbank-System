...
<tr><td colspan="2" align="center"><span style="font-weight: bolder;">Add Town</span> </td></tr>

<tr><td class="lefttd">Town Name</td><td><input type="text" name="t3" required="required" pattern="[a-zA-Z _]{5,15}" title="please enter only character between 5 to 15 for city name"/></td></tr>
