...
<tr><td colspan="2" align="center"> <span style="font-weight: bolder;">Add Camp Gallery </span></td></tr>
...
<tr><td class="lefttd">Pic Title</td><td><input type="text" name="t3"  required="required" pattern="[a-zA-Z0-9 ]{5,15}" title="please enter only character or numbers between 5 to 15 for pic title"></td></tr>
</td></tr>
