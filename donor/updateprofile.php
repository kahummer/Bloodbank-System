...
<div style="height:400px; width:700px; margin:auto; margin-top:50px; margin-bottom:50px;  border:2px solid red; ">
 <form method="post">
...
<tr><td class="lefttd">Gender</td><td><input name="r1" type="radio" value="male"  <?php if($gender=="male"){ echo "checked" ;}  ?>>Male<input name="r1"  type="radio" value="female" <?php if($gender=="female"){ echo "checked" ;}  ?> />Female</td></tr>
		...
		<tr><td>&nbsp;</td><td><input type="submit" value="Update" name="sbmt" style="border:0px;width:100px; height:30px; color:white; font-weight:bold; font-size:14px; background-color: red; "></td></tr>	
