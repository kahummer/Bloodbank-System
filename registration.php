...
<tr><td class="lefttd">Gender</td><td><input name="r1" type="radio" value="male" checked="checked">Male
	    <input name="r1" type="radio" value="female" >Female</td></tr>
...
<tr><td>&nbsp;</td><td><input type="submit" value="Register" name="sbmt" style="border:0px;  width:100px; height:30px;  color:white; font-weight:bold; font-size:14px; background-color: red; "></td></tr></table>
</td></tr>
</table>
</form>
